            ...
            (i = document.querySelector("#kt_modal_new_card")) && (o = new bootstrap.Modal(i),
                ...
                fields: {
                    ...
                    klimit: {
                        validators: {
                            notEmpty: {
                                message: "Kullanilabilir limit degeri giriniz"
                            }
                        }
                    }
                    ,
                    kurl: {
                        validators: {
                            notEmpty: {
                                message: "Kart gorselini giriniz."
                            }
                        }
                    }
                },
